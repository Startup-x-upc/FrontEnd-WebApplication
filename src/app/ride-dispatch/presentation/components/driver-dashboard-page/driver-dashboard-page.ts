 ...
 * - List of pending ride requests with "Ver detalles"
 * - Request detail view with accept / skip actions
...
@Component({
  ...
  styles: [`
    ...
    .accept-btn mat-icon { margin-right: 6px; font-size: 20px; height: 20px; width: 20px; }
    .skip-btn {
      height: 48px;
      font-size: 14px;
      font-weight: 600;
