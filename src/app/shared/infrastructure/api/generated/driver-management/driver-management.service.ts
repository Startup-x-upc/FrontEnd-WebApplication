 ...
 */
 toggleAvailability<TData = DriverAvailabilityResponse>(id: string, options?: HttpClientBodyOptions): Observable<TData>;
 toggleAvailability<TData = DriverAvailabilityResponse>(id: string, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 toggleAvailability<TData = DriverAvailabilityResponse>(id: string, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  toggleAvailability<TData = DriverAvailabilityResponse>(
    id: string, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {
    if (options?.observe === 'events') {
      return this.http.post<TData>(
 ...
 */
 getDriverByUserId<TData = DriverResponse>(userId: string, options?: HttpClientBodyOptions): Observable<TData>;
 getDriverByUserId<TData = DriverResponse>(userId: string, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 getDriverByUserId<TData = DriverResponse>(userId: string, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  getDriverByUserId<TData = DriverResponse>(
 ...
 */
 getDriverById<TData = DriverResponse>(id: string, options?: HttpClientBodyOptions): Observable<TData>;
 getDriverById<TData = DriverResponse>(id: string, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 getDriverById<TData = DriverResponse>(id: string, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  getDriverById<TData = DriverResponse>(
    id: string, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {
    if (options?.observe === 'events') {
      return this.http.get<TData>(
      `/api/v1/drivers/${id}`,{
