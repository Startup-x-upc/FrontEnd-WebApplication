...
import type {
  ...
  GetAllDriversParams,
  GetDriverById200,
  GetDriverByUserId200,
  RestrictDriver200,
  RestrictDriverResource,
  ToggleAvailability200,
  UnrestrictDriver200
} from '../model';
 ...
 */
 toggleAvailability<TData = ToggleAvailability200>(id: string, options?: HttpClientBodyOptions): Observable<TData>;
 toggleAvailability<TData = ToggleAvailability200>(id: string, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 toggleAvailability<TData = ToggleAvailability200>(id: string, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  toggleAvailability<TData = ToggleAvailability200>(
    id: string, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {
    if (options?.observe === 'events') {
      return this.http.post<TData>(
 ...
 */
 getDriverByUserId<TData = GetDriverByUserId200>(userId: string, options?: HttpClientBodyOptions): Observable<TData>;
 getDriverByUserId<TData = GetDriverByUserId200>(userId: string, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 getDriverByUserId<TData = GetDriverByUserId200>(userId: string, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  getDriverByUserId<TData = GetDriverByUserId200>(
 ...
 */
 getDriverById<TData = GetDriverById200>(id: string, options?: HttpClientBodyOptions): Observable<TData>;
 getDriverById<TData = GetDriverById200>(id: string, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 getDriverById<TData = GetDriverById200>(id: string, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  getDriverById<TData = GetDriverById200>(
    id: string, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {
    if (options?.observe === 'events') {
      return this.http.get<TData>(
      `/api/v1/drivers/${id}`,{
